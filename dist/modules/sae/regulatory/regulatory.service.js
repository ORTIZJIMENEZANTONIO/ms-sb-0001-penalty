...
let RegulatoryService = class RegulatoryService {
    ...
    async getAllRegulatory({ inicio, pageSize }) {
    ...
    async createRegulatory(regulatoryDTO) {
        return await this.entity.save(regulatoryDTO);
    }
    async updateRegulatory(id, regulatoryDTO) {
        const task = await this.entity.findOne({ where: { id: id } });
        if (task) {
            this.entity.merge(task, regulatoryDTO);
...
RegulatoryService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(regulatory_entity_1.RegulatoryEntity)),
    __param(1, (0, common_1.Inject)(nest_winston_1.WINSTON_MODULE_PROVIDER)),
    __param(2, (0, nestjs_prometheus_1.InjectMetric)('regulatory_served')),
