...
SiabClasificationModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([siab_clasification_entity_1.SiabClasificationEntity])],
        providers: [siab_clasification_service_1.SiabClasificationService,
            (0, nestjs_prometheus_1.makeCounterProvider)({
                name: 'siab_clasification_served',
                help: 'siab_clasification_help'
            })
        ],
