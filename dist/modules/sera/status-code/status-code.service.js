...
exports.StatusCodeService = void 0;
...
let StatusCodeService = class StatusCodeService {
    ...
    async getAllStatusCode({ inicio, pageSize }) {
    ...
    async createStatusCode(statusCodeDTO) {
        return await this.entity.save(statusCodeDTO);
    }
    async updateStatusCode(id, statusCodeDTO) {
        const task = await this.entity.findOne({ where: { id: id } });
        if (task) {
            this.entity.merge(task, statusCodeDTO);
...
StatusCodeService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(status_code_entity_1.StatusCodeEntity)),
    __param(1, (0, common_1.Inject)(nest_winston_1.WINSTON_MODULE_PROVIDER)),
    __param(2, (0, nestjs_prometheus_1.InjectMetric)('statusCode_served')),
