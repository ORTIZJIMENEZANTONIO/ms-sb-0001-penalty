...
let PersonService = class PersonService {
    ...
    async getAllPerson({ inicio, pageSize }) {
    ...
    async createPerson(personDTO) {
        return await this.entity.save(personDTO);
    }
    async updatePerson(id, personDTO) {
        const task = await this.entity.findOne({ where: { id: id } });
        if (task) {
            this.entity.merge(task, personDTO);
...
PersonService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(person_entity_1.PersonEntity)),
    __param(1, (0, common_1.Inject)(nest_winston_1.WINSTON_MODULE_PROVIDER)),
    __param(2, (0, nestjs_prometheus_1.InjectMetric)('person_served')),
