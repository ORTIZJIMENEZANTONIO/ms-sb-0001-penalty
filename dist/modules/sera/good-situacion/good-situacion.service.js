...
let GoodSituacionService = class GoodSituacionService {
    ...
    async getAllGoodSituacion({ inicio, pageSize }) {
    ...
    async createGoodSituacion(goodSituacionDTO) {
        return await this.entity.save(goodSituacionDTO);
    }
    async updateGoodSituacion(id, goodSituacionDTO) {
        const task = await this.entity.findOne({ where: { id: id } });
        if (task) {
            this.entity.merge(task, goodSituacionDTO);
...
GoodSituacionService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(good_situacion_entity_1.GoodSituacionEntity)),
    __param(1, (0, common_1.Inject)(nest_winston_1.WINSTON_MODULE_PROVIDER)),
    __param(2, (0, nestjs_prometheus_1.InjectMetric)('goodSituacion_served')),
