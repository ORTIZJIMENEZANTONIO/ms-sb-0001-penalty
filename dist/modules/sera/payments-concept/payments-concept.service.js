...
let PaymentsConceptService = class PaymentsConceptService {
    ...
    async getAllPaymentsConcept({ inicio, pageSize }) {
    ...
    async createPaymentsConcept(paymentsConceptDTO) {
        return await this.entity.save(paymentsConceptDTO);
    }
    async updatePaymentsConcept(id, paymentsConceptDTO) {
        const task = await this.entity.findOne({ where: { id: id } });
        if (task) {
            this.entity.merge(task, paymentsConceptDTO);
...
PaymentsConceptService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(payments_concept_entity_1.PaymentsConceptEntity)),
    __param(1, (0, common_1.Inject)(nest_winston_1.WINSTON_MODULE_PROVIDER)),
    __param(2, (0, nestjs_prometheus_1.InjectMetric)('paymentsConcept_served')),
