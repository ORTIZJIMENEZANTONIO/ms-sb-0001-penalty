...
let ProficientService = class ProficientService {
    ...
    async getAllProficient({ inicio, pageSize }) {
    ...
    async createProficient(proficientDTO) {
        return await this.entity.save(proficientDTO);
    }
    async updateProficient(id, proficientDTO) {
        const task = await this.entity.findOne({ where: { id: id } });
        if (task) {
            this.entity.merge(task, proficientDTO);
...
ProficientService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(proficient_entity_1.ProficientEntity)),
    __param(1, (0, common_1.Inject)(nest_winston_1.WINSTON_MODULE_PROVIDER)),
    __param(2, (0, nestjs_prometheus_1.InjectMetric)('proficient_served')),
