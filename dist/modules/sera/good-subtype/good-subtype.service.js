...
let GoodSubtypeService = class GoodSubtypeService {
    ...
    async getAllGoodSubtype({ inicio, pageSize }) {
    ...
    async createGoodSubtype(goodSubtypeDTO) {
        return await this.entity.save(goodSubtypeDTO);
    }
    async updateGoodSubtype(id, goodSubtypeDTO) {
        const task = await this.entity.findOne({ where: { id: id } });
        if (task) {
            this.entity.merge(task, goodSubtypeDTO);
...
GoodSubtypeService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(good_subtype_entity_1.GoodSubtypeEntity)),
    __param(1, (0, common_1.Inject)(nest_winston_1.WINSTON_MODULE_PROVIDER)),
    __param(2, (0, nestjs_prometheus_1.InjectMetric)('goodSubtype_served')),
