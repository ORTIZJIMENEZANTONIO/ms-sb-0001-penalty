...
let NotaryService = class NotaryService {
    constructor(entity, logger, counter) {
        this.entity = entity;
        this.logger = logger;
        this.counter = counter;
    }
    async getAllNotary({ inicio, pageSize }) {
    ...
    async createNotary(notaryDTO) {
        return await this.entity.save(notaryDTO);
    }
    async updateNotary(id, notaryDTO) {
        const task = await this.entity.findOne({ where: { id: id } });
        if (task) {
            this.entity.merge(task, notaryDTO);
...
NotaryService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(notary_entity_1.NotaryEntity)),
    __param(1, (0, common_1.Inject)(nest_winston_1.WINSTON_MODULE_PROVIDER)),
    __param(2, (0, nestjs_prometheus_1.InjectMetric)('notary_served')),
