...
let ReportService = class ReportService {
    ...
    async getAllReport({ inicio, pageSize }) {
    ...
    async createReport(reportDTO) {
        return await this.entity.save(reportDTO);
    }
    async updateReport(id, reportDTO) {
        const task = await this.entity.findOne({ where: { id: id } });
        if (task) {
            this.entity.merge(task, reportDTO);
...
ReportService = __decorate([
    ...
    __param(2, (0, nestjs_prometheus_1.InjectMetric)('report_served')),
