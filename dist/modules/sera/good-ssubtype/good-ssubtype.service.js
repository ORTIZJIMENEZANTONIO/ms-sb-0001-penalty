...
const good_ssubtype_entity_1 = require("./entity/good-ssubtype.entity");
let GoodSsubtypeService = class GoodSsubtypeService {
    ...
    async getAllGoodSsubtype({ inicio, pageSize }) {
    ...
    async createGoodSsubtype(goodSsubtypeDTO) {
        return await this.entity.save(goodSsubtypeDTO);
    }
    async updateGoodSsubtype(id, goodSsubtypeDTO) {
        const task = await this.entity.findOne({ where: { id: id } });
        if (task) {
            this.entity.merge(task, goodSsubtypeDTO);
...
GoodSsubtypeService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(good_ssubtype_entity_1.GoodSsubtypeEntity)),
    __param(1, (0, common_1.Inject)(nest_winston_1.WINSTON_MODULE_PROVIDER)),
    __param(2, (0, nestjs_prometheus_1.InjectMetric)('goodSsubtype_served')),
