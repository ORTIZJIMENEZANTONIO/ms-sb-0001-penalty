...
const revision_reason_entity_1 = require("./entity/revision-reason.entity");
let RevisionReasonService = class RevisionReasonService {
    ...
    async getAllRevisionReason({ inicio, pageSize }) {
    ...
    async createRevisionReason(revisionReasonDTO) {
        return await this.entity.save(revisionReasonDTO);
    }
    async updateRevisionReason(id, revisionReasonDTO) {
        const task = await this.entity.findOne({ where: { id: id } });
        if (task) {
            this.entity.merge(task, revisionReasonDTO);
...
RevisionReasonService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(revision_reason_entity_1.RevisionReasonEntity)),
    __param(1, (0, common_1.Inject)(nest_winston_1.WINSTON_MODULE_PROVIDER)),
    __param(2, (0, nestjs_prometheus_1.InjectMetric)('revisionReason_served')),
