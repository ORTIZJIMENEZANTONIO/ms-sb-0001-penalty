...
let MediumPhotographyService = class MediumPhotographyService {
    ...
    async getAllMediumPhotography({ inicio, pageSize }) {
    ...
    async createMediumPhotography(mediumPhotographyDTO) {
        return await this.entity.save(mediumPhotographyDTO);
    }
    async updateMediumPhotography(id, mediumPhotographyDTO) {
        const task = await this.entity.findOne({ where: { id: id } });
        if (task) {
            this.entity.merge(task, mediumPhotographyDTO);
...
MediumPhotographyService = __decorate([
    ...
    __param(0, (0, typeorm_2.InjectRepository)(medium_photography_entity_1.MediumPhotographyEntity)),
    __param(1, (0, common_1.Inject)(nest_winston_1.WINSTON_MODULE_PROVIDER)),
    __param(2, (0, nestjs_prometheus_1.InjectMetric)('mediumPhotography_served')),
