...
const locker_entity_1 = require("./entity/locker.entity");
let LockerService = class LockerService {
    ...
    async getAllLocker({ inicio, pageSize }) {
    ...
    async createLocker(lockerDTO) {
        return await this.entity.save(lockerDTO);
    }
    async updateLocker(id, lockerDTO) {
        const task = await this.entity.findOne({ where: { id: id } });
        if (task) {
            this.entity.merge(task, lockerDTO);
...
LockerService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(locker_entity_1.LockerEntity)),
    __param(1, (0, common_1.Inject)(nest_winston_1.WINSTON_MODULE_PROVIDER)),
    __param(2, (0, nestjs_prometheus_1.InjectMetric)('locker_served')),
