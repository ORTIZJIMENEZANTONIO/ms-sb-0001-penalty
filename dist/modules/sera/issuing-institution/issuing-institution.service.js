...
let IssuingInstitutionService = class IssuingInstitutionService {
    ...
    async getAllIssuingInstitution({ inicio, pageSize }) {
    ...
    async createIssuingInstitution(issuingInstitutionDTO) {
        return await this.entity.save(issuingInstitutionDTO);
    }
    async updateIssuingInstitution(id, issuingInstitutionDTO) {
        const task = await this.entity.findOne({ where: { id: id } });
        if (task) {
            this.entity.merge(task, issuingInstitutionDTO);
...
IssuingInstitutionService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(issuing_institution_entity_1.IssuingInstitutionEntity)),
    __param(1, (0, common_1.Inject)(nest_winston_1.WINSTON_MODULE_PROVIDER)),
    __param(2, (0, nestjs_prometheus_1.InjectMetric)('issuingInstitution_served')),
