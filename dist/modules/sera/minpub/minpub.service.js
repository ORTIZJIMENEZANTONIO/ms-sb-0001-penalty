...
let MinpubService = class MinpubService {
    ...
    async getAllMinpub({ inicio, pageSize }) {
    ...
    async createMinpub(minpubDTO) {
        return await this.entity.save(minpubDTO);
    }
    async updateMinpub(id, minpubDTO) {
        const task = await this.entity.findOne({ where: { id: id } });
        if (task) {
            this.entity.merge(task, minpubDTO);
...
MinpubService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(minpub_entity_1.MinpubEntity)),
    __param(1, (0, common_1.Inject)(nest_winston_1.WINSTON_MODULE_PROVIDER)),
    __param(2, (0, nestjs_prometheus_1.InjectMetric)('minpub_served')),
