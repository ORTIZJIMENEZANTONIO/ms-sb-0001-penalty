...
let SubdelegationService = class SubdelegationService {
    ...
    async getAllSubdelegation({ inicio, pageSize }) {
    ...
    async createSubdelegation(subdelegationDTO) {
        return await this.entity.save(subdelegationDTO);
    }
    async updateSubdelegation(id, subdelegationDTO) {
        const task = await this.entity.findOne({ where: { id: id } });
        if (task) {
            this.entity.merge(task, subdelegationDTO);
...
SubdelegationService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(subdelegation_entity_1.SubdelegationEntity)),
    __param(1, (0, common_1.Inject)(nest_winston_1.WINSTON_MODULE_PROVIDER)),
    __param(2, (0, nestjs_prometheus_1.InjectMetric)('subdelegation_served')),
