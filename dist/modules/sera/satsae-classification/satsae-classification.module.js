...
SatsaeClassificationModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [
            satsae_classification_service_1.SatsaeClassificationService,
            (0, nestjs_prometheus_1.makeCounterProvider)({
                name: 'satsae_classification_served',
                help: 'satsae_classification_help'
            })
        ],
        imports: [
            typeorm_1.TypeOrmModule.forFeature([
                satsae_classification_entity_1.SatSaeClassificationEntity
            ])
        ]
    })
