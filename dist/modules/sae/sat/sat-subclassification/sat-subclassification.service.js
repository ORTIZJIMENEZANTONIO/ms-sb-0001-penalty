...
let SatSubclassificationService = class SatSubclassificationService {
    ...
    async getAllSatSubClassification({ inicio, pageSize }) {
    ...
    async createSatSubClassification(satSubClassificationDTO) {
        return await this.entity.save(satSubClassificationDTO);
    }
    async updateSatSubClassification(id, satSubClassificationDTO) {
        const task = await this.entity.findOne({ where: { id: id } });
        if (task) {
            this.entity.merge(task, satSubClassificationDTO);
...
SatSubclassificationService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(sat_subclassification_entity_1.SatSubClassificationEntity)),
    __param(1, (0, common_1.Inject)(nest_winston_1.WINSTON_MODULE_PROVIDER)),
    __param(2, (0, nestjs_prometheus_1.InjectMetric)('sat_subclassification_served')),
