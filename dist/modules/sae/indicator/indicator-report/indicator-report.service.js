...
let IndicatorReportService = class IndicatorReportService {
    ...
    async getAllIndicatorReport({ inicio, pageSize }) {
    ...
    async updateIndicatorReport(id, indicatorDeadlinesDTO) {
...
IndicatorReportService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(indicator_report_entity_1.IndicatorReportEntity)),
    __param(1, (0, common_1.Inject)(nest_winston_1.WINSTON_MODULE_PROVIDER)),
    __param(2, (0, nestjs_prometheus_1.InjectMetric)('indicator_report_served')),
