...
let HalfImageService = class HalfImageService {
    ...
    async getAllHalfImage({ inicio, pageSize }) {
    ...
    async createHalfImage(halfImageDTO) {
        return await this.entity.save(halfImageDTO);
    }
    async updateHalfImage(id, halfImageDTO) {
        const task = await this.entity.findOne({ where: { id: id } });
        if (task) {
            this.entity.merge(task, halfImageDTO);
...
HalfImageService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(half_image_entity_1.HalfImageEntity)),
    __param(1, (0, common_1.Inject)(nest_winston_1.WINSTON_MODULE_PROVIDER)),
    __param(2, (0, nestjs_prometheus_1.InjectMetric)('halfImage_served')),
